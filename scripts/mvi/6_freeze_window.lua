-- By default, mpv automatically resizes the window when the current file changes to fit its size. This script freezes the window so that this does not happen -- credit to TheAMM
...
mp.register_idle(function()
  ...
  if not ww or ww <= 0 or
     not wh or wh <= 0 then return end
